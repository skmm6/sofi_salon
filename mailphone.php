...
$mail->addAddress('victoriasherbach049@gmail.com');     // Кому будет уходить письмо 
...
$mail->Subject = 'Заявка с сайта Софи';
$mail->Body    = '' . 'Клиент с почтой '  . '' .$email . ' оставил заявку, его телефон ' .$phone; //. '<br>Почта этого пользователя: ' .$email;
$mail->AltBody = '';
